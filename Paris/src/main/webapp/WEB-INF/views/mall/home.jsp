...
<body>
  ...
  <main>
	  	<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="${pageContext.request.contextPath}/resources/common/images/image_main2.jpeg" class="d-block w-100" alt="...">
				
					</div>
					<div class="carousel-item">
						<img src="${pageContext.request.contextPath}/resources/common/images/image_main.webp" class="d-block w-100" alt="...">
					</div>
				</div>
		...
		<div class="item_controll01">
			<div class="item_content">
				<div id="carouselExampleControls01" class="carousel slide" data-bs-ride="carousel" style="width: 250px" >
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="../../html/user/productPage.html">
							<img src="${pageContext.request.contextPath}/resources/common/images/man_top04.jpeg" class="d-block w-100" alt="...">
							</a>
						</div>
						<div class="carousel-item">
							<a href="../../html/user/productPage.html"></a>
							<img src="${pageContext.request.contextPath}/resources/common/images/man_top04.jpeg" class="d-block w-100" alt="...">
						</div>
						<div class="carousel-item">
							<a href="../../html/user/productPage.html"></a>
			...
			<div class="item_content">
				<div id="carouselExampleControls02" class="carousel slide " data-bs-ride="carousel" style="width: 250px">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="../../html/user/productPage.html">
								<img src="${pageContext.request.contextPath}/resources/common/images/man_top01.jpeg" class="d-block w-100" alt="...">
							</a>
						</div>
						<div class="carousel-item">
							<a href="../../html/user/productPage.html">
			...
			<div class="item_content">
				<div id="carouselExampleControls03" class="carousel slide " data-bs-ride="carousel" style="width: 250px">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="../../html/user/productPage.html">
								<img src="${pageContext.request.contextPath}/resources/common/images/ma_top02.jpeg" class="d-block w-100" alt="...">
							</a>
						</div>
						<div class="carousel-item">
							<a href="../../html/user/productPage.html">
			...
			<div class="item_content">
				<div id="carouselExampleControls04" class="carousel slide " data-bs-ride="carousel" style="width: 250px">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="../../html/user/productPage.html">
								<img src="${pageContext.request.contextPath}/resources/common/images/man_top03.jpeg" class="d-block w-100" alt="...">
							</a>
						</div>
						<div class="carousel-item">
							<a href="../../html/user/productPage.html">
	...
	<div class="image_info">
		<img src="${pageContext.request.contextPath}/resources/common/images/1.jpeg" width="100%">
	</div>
	<div class="image_info">
		<img src="${pageContext.request.contextPath}/resources/common/images/2.jpeg" width="100%">
	</div>
	<video style="width: 1051px; height: 591px; left: 0px; top: 89px;" src="./gray.mp4"></video>
	<!-- <iframe src="https://www.youtube.com/embed/_ISVNitXvl0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen" title="정의" width="100%" height="600px"></iframe> -->
  </main>
  <footer>
